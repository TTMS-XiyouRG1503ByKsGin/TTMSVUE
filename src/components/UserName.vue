<template>
    <div class="UserName">
        <div class="UserName-content">
            <div class="UserName-content-addbtn content-btn">添加用户</div>
            <div class="UserName-content-main">
                <div class="UserName-content-main-title">
                    <span class="UserName-content-main-id">演出计划ID</span>
                    <span class="UserName-content-main-cinema">所在影厅名称</span>
                    <span class="UserName-content-main-play">演出剧目</span>
                    <span class="UserName-content-main-time">演出时间</span>
